...
def solve_biot_dg(dt, F, g, exact_u, exact_p, levelset, quad_mesh, mu,lam,tau_fpl,lambda_u,lambda_p,gamma_s,gamma_p,gamma_m,alpha,M,k, order=1, h=0.1):
...
for k in range(2, 6):
    ...
    fes,invmstar,lh,mh,mesh = solve_biot_dg(dt, b, f, exact_u, exact_p, levelset, quad_mesh, \
                                            mu,lam,tau_fpl,lambda_u,lambda_p,gamma_s,gamma_p,gamma_m,alpha,M,k, order, h0)
    gfu = GridFunction(fes)
